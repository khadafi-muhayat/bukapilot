...
void StatusLabel::setText(const QString &t)
{
  if (text == t)
    return;
  text = t;
...
void StatusLabel::setIconDir(const QString &idir)
{
  if (icon_dir == idir)
    return;
  icon_dir = idir;
...
StatusWidget::StatusWidget(QWidget *parent) : QWidget(parent){
    ...
    QObject::connect(uiState(), &UIState::uiUpdate, this, &StatusWidget::updateState);
}
...
DriveWidget::DriveWidget(QWidget *parent) : QWidget(parent){
    ...
    QObject::connect(uiState(), &UIState::uiUpdate, this, &DriveWidget::updateState);
}
